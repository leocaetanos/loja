...
import (
	...
	"github.com/leocaetanos/loja/models"
)
...
func Insert(w http.ResponseWriter, r *http.Request) {
	if r.Method == "POST" {
		...
		quantidadeConvertidParaInt, err := strconv.Atoi(quantidade)
		if err != nil {
			log.Println("Erro na conversão da quantidade:", err)
		}

		models.CriaNovoProduto(nome, descricao, precoConvertidoParaFloat, quantidadeConvertidParaInt)
